...
**Icy Island:**
  ...
  - By the time he reaches the exit of the cave the sun begins to rise.
  ...
  - When the Yeti is beat, Tux remembers a note signed by Nolok that he found inside the castle, informing Tux on the crystal mines and a boat to use to sail up north.
  - The sun sets when Tux arrives at the crystal mines. He starts sailing up north, during the night.

**Rooted Forest:**
  - Tux arrives at sunrise.
  - For the first half of Rooted Forest, Tux explores the new land, looking for clues on where the next castle is located.
  ...
  - When Tux leaves the cave the next day dawns and Tux decides to take a small nap.
  ...
  - Surviving Granito thank Tux and wish to help Tux on his journey, leading him to the tropical island Nolok had mentioned in a note.
...
**Tropical Paradise:**
  ...
  - Toucan is found inside the throne room, admiring himself on a painting.
...
> If Tux does have all five NOLOK-keys collected:
  ...
  - Nolok is shocked that Tux has defeated him. Suddenly the tower begins to crumble, and Tux goes to the room where Penny is, and releases her.
  - The castle falls through miles of cloud until reaching the ground and breaking into several pieces. Tux and Penny notice they are back in Antarctica,
    and Nolok jumps up and runs off somewhere, throwing purple roots behind him to prevent any attempt to follow him.
  - **The End**
